...
import static com.myapp.domain.StudentAsserts.*;
...
class StudentResourceIT {
    ...
    public static Student createEntity() {
        return new Student().name(DEFAULT_NAME).lastName(DEFAULT_LAST_NAME);
    }
    ...
    public static Student createUpdatedEntity() {
        return new Student().name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
    }
    ...
    void putExistingStudent() throws Exception {
        ...
        updatedStudent.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);

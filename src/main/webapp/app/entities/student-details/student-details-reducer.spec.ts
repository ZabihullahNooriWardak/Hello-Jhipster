...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUDENTDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTDETAILS actions', async () => {
      const arg = 42666;

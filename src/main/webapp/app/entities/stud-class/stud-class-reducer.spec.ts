...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDCLASS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDCLASS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDCLASS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUDCLASS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDCLASS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDCLASS actions', async () => {
      const arg = 42666;

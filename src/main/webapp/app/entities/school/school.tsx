  ...
  return (
    <div>
      <h2 id="school-heading" data-cy="SchoolHeading">
        <Translate contentKey="wednesdayApp.school.home.title">Schools</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="wednesdayApp.school.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/school/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="wednesdayApp.school.home.createLabel">Create new School</Translate>
          </Link>
        </div>
      </h2>
        ...
        {schoolList && schoolList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="wednesdayApp.school.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="wednesdayApp.school.home.notFound">No Schools found</Translate>
            </div>
          )
        )}
      </div>

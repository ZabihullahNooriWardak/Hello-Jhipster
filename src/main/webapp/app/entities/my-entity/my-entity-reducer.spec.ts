...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './my-entity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYENTITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MYENTITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MYENTITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MYENTITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MYENTITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MYENTITY actions', async () => {
      const arg = 42666;
